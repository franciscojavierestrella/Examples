package com.mindundis.rfbloyalty.config;

import com.mindundis.rfbloyalty.security.*;
...
import com.mindundis.rfbloyalty.security.oauth2.AudienceValidator;
...
import com.mindundis.rfbloyalty.security.oauth2.JwtAuthorityExtractor;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/rfb-eventattendance/**").hasAuthority(AuthoritiesConstants.ADMIN)
