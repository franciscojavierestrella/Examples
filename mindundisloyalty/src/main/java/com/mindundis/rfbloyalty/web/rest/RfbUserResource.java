...
import com.mindundis.rfbloyalty.service.RfbUserService;
import com.mindundis.rfbloyalty.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.mindundis.rfbloyalty.domain.RfbUser}.
 */
@RestController
@RequestMapping("/api")
